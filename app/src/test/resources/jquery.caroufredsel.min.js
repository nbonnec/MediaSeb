...
var jq_carou = jQuery.noConflict();
jq_carou(document).ready(function(a) {
    a(".modopaccar").each(function() {
        a(this).carouFredSel({
            auto: (a(this).attr("data-auto") === "true"),
            width: "100%",
            direction: a(this).attr("data-direction"),
            scroll: {
                items: isNaN(a(this).attr("data-items")) ? a(this).attr("data-items") : parseInt(a(this).attr("data-items")),
                fx: a(this).attr("data-fx"),
                duration: a(this).attr("data-duration"),
                pauseOnHover: a(this).attr("data-pauseOnHover")
            },
            prev: {
                button: "#mod_car_" + a(this).attr("data-modid") + "_prev",
                key: "left"
            },
            next: {
                button: "#mod_car_" + a(this).attr("data-modid") + "_next",
                key: "right"
            }
        })
    })
